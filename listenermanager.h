...
public:
    ListenerManager(ArtistRepository& artistRepository,
                    AlbumRepository& albumRepository,
                    SongRepository& songRepository,
                    PlaylistRepository& playlistRepository,
                    listenrRepository& listenerRepository);
    ...
    bool editPlaylist(int playlistId,
                      int userId,
                      const std::string& newName);

    bool addSongToPlaylist(int playlistId,
                           int userId,
                           int songId);

    bool removeSongFromPlaylist(int playlistId,
                                int userId,
                                int songId);
